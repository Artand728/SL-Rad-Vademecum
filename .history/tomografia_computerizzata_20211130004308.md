...
- **VIE URINARIE IN FASE TARDIVA (10')**
  - Se le **vie urinarie non sono completamente opacizzate in tardiva** può essere dovuto alla **peristalsi ureterale** 
    - a meno che il quesito non sia esplicitamente mirato a escludere una ostruzione (magari neoplastica) potrebbe non essere necessario seseguire un ripassaggio. 
